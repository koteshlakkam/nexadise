...
const STEPS = [
	{
		n: "01",
		title: "Connect Gmail",
		body: "One click. We never store passwords — only what's needed to read and act.",
	},
	{
		n: "02",
		title: "nexadise reads & decides",
		body: "Every message is summarized and classified by intent and urgency.",
	},
	{
		n: "03",
		title: "You approve, it ships",
		body: "Pre-drafted replies, calendar invites, and tasks — one tap to confirm.",
	},
];
...
const STATS = [
	{
		...
		body: "Triaged, summarized, and turned into clear next steps — across founders' inboxes.",
	},
	{
		value: "5 hrs",
		label: "Saved per user, per week",
		body: "Time reclaimed from triage and reply drafting — back to the work that actually ships.",
	},
];
...
export default function HomePage() {
	...
	return (
		<main className="relative overflow-hidden bg-white">
			{/* Top glow */}
			<div
				className="pointer-events-none absolute inset-x-0 top-0 h-[600px] bg-hero-glow"
				aria-hidden
			/>
			...
			<section className="relative pt-16 pb-24 sm:pt-24 sm:pb-32">
				<Container size="xl">
					<div className="mx-auto max-w-3xl text-center">
						...
						>
							nexadise reads your inbox, decides what matters, and
							drafts the next move — so your morning starts with a
							calm list of decisions, not a wall of email.
						</motion.p>
						...
						>
							No credit card · Free during beta · Connect &
							disconnect anytime
						</motion.p>
					</div>
			...
			{/* STATS STRIP */}
			<section className="border-y border-ink-100 bg-surface-muted/40 py-14 sm:py-16">
				<Container size="xl">
					<p className="text-center text-2xs font-semibold uppercase tracking-wide text-brand-600">
						Real impact
					</p>
					<h2 className="mx-auto mt-3 max-w-2xl text-balance text-center text-2xl font-semibold tracking-tighter2 text-ink-900 sm:text-3xl">
						Processed 10,000+ emails. Saved 5 hours a week per user.
					</h2>
					...
					<div className="mx-auto mt-10 grid max-w-4xl gap-4 sm:grid-cols-2">
						{STATS.map((s, i) => (
							<motion.div
								...
								className="rounded-2xl border border-ink-200 bg-white p-7 shadow-xs"
							>
								<p className="bg-gradient-to-br from-brand-600 via-brand-500 to-violet-500 bg-clip-text text-4xl font-semibold tracking-tighter2 text-transparent sm:text-5xl">
									{s.value}
								</p>
								<p className="mt-3 text-sm font-semibold tracking-tightish text-ink-900">
									{s.label}
								</p>
				...
				<Container size="xl">
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-base leading-relaxed text-ink-600">
							Three quiet superpowers that turn your inbox from a
							to-do list into a done list.
						</p>
					</div>
			...
			<section id="demo" className="py-24 sm:py-32">
				<Container size="xl">
					<div className="mx-auto max-w-2xl text-center">
						...
						<p className="mt-4 text-base leading-relaxed text-ink-600">
							Live preview of the workflow. No setup. No demos to
							book.
						</p>
					</div>
				...
				<Container size="md">
					<figure className="rounded-3xl border border-ink-200 bg-gradient-to-br from-white via-brand-50/30 to-violet-50/30 p-10 text-center shadow-soft">
						<blockquote className="text-balance text-xl font-medium leading-relaxed tracking-tightish text-ink-800 sm:text-2xl">
							“nexadise gave us back two hours a day. It's the
							first tool that actually{" "}
							<em className="not-italic text-brand-700">does</em>{" "}
							something with my inbox instead of just showing it
							to me.”
						</blockquote>
					</figure>
				</Container>
				...
				<Container size="lg">
					<div className="relative overflow-hidden rounded-3xl border border-ink-900/5 bg-ink-900 px-8 py-16 text-center sm:px-16">
						...
						<p className="mx-auto mt-4 max-w-lg text-balance text-base leading-relaxed text-white/70">
							Connect Gmail in one click. nexadise handles the
							rest while you get on with the work that actually
			...
			<footer className="border-t border-ink-100 py-10">
				<Container size="xl">
					<div className="flex flex-col items-center justify-between gap-4 sm:flex-row">
						...
						<div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2 text-2xs text-ink-500">
							<a
								href="#features"
