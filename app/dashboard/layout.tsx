...
const NAV_PRIMARY = [
  { href: "/dashboard", label: "Today", icon: <Icon.Inbox className="h-4 w-4" /> },
  { href: "/dashboard/inbox", label: "Inbox", icon: <Icon.Mail className="h-4 w-4" /> },
  { href: "/dashboard/actions", label: "Actions", icon: <Icon.Bolt className="h-4 w-4" /> },
  { href: "/dashboard/insights", label: "Insights", icon: <Icon.Sparkles className="h-4 w-4" /> },
];
...
const NAV_WORKSPACE = [
  ...
  { href: "/dashboard/account", label: "Account", icon: <Icon.User className="h-4 w-4" /> },
];
        ...
        <aside className="sticky top-14 hidden h-[calc(100vh-3.5rem)] w-60 shrink-0 overflow-y-auto border-r border-ink-100 bg-white/60 px-3 py-6 lg:block">
          ...
          <div className="mt-8 rounded-xl border border-brand-100 bg-gradient-to-br from-brand-50 to-violet-50 p-4">
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm font-semibold text-ink-900">Nexadise Pro</p>
            </div>
            <p className="mt-2 text-2xs leading-relaxed text-ink-600">
              Unlimited AI analysis, calendar drafts, and team workflows.
            </p>
            <Button size="sm" variant="primary" fullWidth className="mt-3">
              Upgrade
            </Button>
          </div>
        </aside>
